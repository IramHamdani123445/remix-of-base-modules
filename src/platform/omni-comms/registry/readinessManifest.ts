...
export const OMNI_COMMS_READINESS_MANIFEST: OmniCommsReadinessManifest = {
  ...
  foundationStatus: [
    ...
    { item: 'Slice 2c-iii runtime certification',             state: 'Pending', note: 'Slice 2c-iii is implementation-only. End-to-end rendering, held-job and timeline behaviour against the deployed Edge Function still requires a privileged run, exactly as for Slice 2c-ii. No live send capability exists or is claimed.' },
  ],
