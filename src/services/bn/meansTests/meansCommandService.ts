...
export type BnMeansCommandErrorCode =
  ...
  | 'POLICY_NO_LONGER_EFFECTIVE'
  | 'APPROVAL_ALREADY_RECORDED'
  | 'REJECTION_ALREADY_RECORDED'
  | 'TARGET_KIND_INVALID'
  | 'CURRENCY_REQUIRED'
  | 'DECISION_INVALID'
...
const KNOWN_ERROR_CODES = new Set<string>([
  ...
  'OPEN_ADJUSTMENT_EXISTS', 'DUPLICATE_OPEN_ADJUSTMENT', 'ADJUSTMENT_ALREADY_DECIDED',
  'STALE_ADJUSTMENT_VERSION', 'ADJUSTMENT_APPLICATION_PENDING', 'CALCULATION_NOT_LATEST',
  'CALCULATION_HASH_MISMATCH', 'CALCULATION_STALE', 'NO_CURRENT_CALCULATION',
