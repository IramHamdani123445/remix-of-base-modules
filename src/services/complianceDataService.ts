...
// EMPLOYER STATEMENTS
// ============================================
// The Employer Statement Register is served by the governed reader
// `ce_employer_statement_register_v1` (see src/hooks/compliance/useEmployerStatements.ts)
// and a single employer's statement by `ce_generate_employer_statement`
// (see src/hooks/useComplianceLedger.ts). Both compute balances from the posted,
// non-reversed ledger with the statutory allocation waterfall applied, so no
// client-side ledger aggregation exists here any more.
