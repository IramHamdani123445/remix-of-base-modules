...
beforeEach(() => {
  [detail, availableActions, calculationReadiness, calculationWorkspace, benefit360Summary, execute, verificationWorkspace]
    .forEach((m) => m.mockReset());
  calculationWorkspace.mockResolvedValue({ status: 'OK', data: null });
});
