-- FINAL-E2E-DEF-05 (part 2), retry preserving the parameter default.
CREATE OR REPLACE FUNCTION public.ia_complete_preparation(p_engagement_id uuid, p_notes text DEFAULT NULL::text)
RETURNS jsonb
LANGUAGE plpgsql
SECURITY DEFINER
