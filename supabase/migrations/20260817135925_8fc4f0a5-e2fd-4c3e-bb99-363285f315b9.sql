CREATE OR REPLACE FUNCTION public.omni_comms_priv_print_production_claim(p_worker text, p_batch_limit integer, p_correlation_id text, p_deployed_revision text)
 RETURNS jsonb
 LANGUAGE plpgsql
 SECURITY DEFINER
