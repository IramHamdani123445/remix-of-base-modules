DROP FUNCTION IF EXISTS public.omni_comms_print_queue_list(uuid,uuid,text[],uuid,text,integer,integer);
...
REVOKE ALL ON FUNCTION public.omni_comms_print_queue_list(uuid,text[],text,uuid,uuid,integer,integer) FROM public;
GRANT EXECUTE ON FUNCTION public.omni_comms_print_queue_list(uuid,text[],text,uuid,uuid,integer,integer) TO authenticated, service_role;